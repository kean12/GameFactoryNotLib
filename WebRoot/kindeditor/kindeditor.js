...
KE.plugin['paste'] = {
	click : function(id) {
		try {
			...
			alertDialog(KE.lang.pasteError);
			return;
		}
...
KE.plugin['flash'] = {
	...
	check : function(id, url, width, height) {
		if (!url.match(/^.{3,}$/)) {
			alertDialog(KE.lang['invalidUrl']);
			window.focus();
			this.dialog.yesButton.focus();
			return false;
		}
		if (!width.match(/^\d*$/)) {
			alertDialog(KE.lang['invalidWidth']);
			window.focus();
			this.dialog.yesButton.focus();
			return false;
		}
		if (!height.match(/^\d*$/)) {
			alertDialog(KE.lang['invalidHeight']);
			window.focus();
			this.dialog.yesButton.focus();
			return false;
		}
...
KE.plugin['image'] = {
	...
	check : function(id) {
		...
		if (!url.match(/\.(jpg|jpeg|gif|bmp|png)(\s|$)/i)) {
			alertDialog(KE.lang['invalidImg']);
			window.focus();
			this.dialog.yesButton.focus();
			return false;
		}
...
KE.plugin['media'] = {
	...
	check : function(id, url, width, height) {
		if (!url.match(/^.{3,}\.(swf|flv|mp3|wav|wma|wmv|mid|avi|mpg|mpeg|asf|rm|rmvb)(\?|$)/i)) {
			alertDialog(KE.lang['invalidMedia']);
			window.focus();
			this.dialog.yesButton.focus();
			return false;
		}
