		...
		<div class="yhzx_rightside">
			...
			<div id="rightnav">
				<ul>
					...
					<li class="normal_nav">
						<span onclick="window.location='${ctx}/user/trade/order/list_defendant.shtml'">接收投诉</span>
					</li>
				</ul>
			</div>
			<div class="contentbox" id="box0" style="display: block">
				...
				<div class="manu">
					...
					<form name="pageForm" action="${ctx}/user/trade/order/list_complaint.shtml" method="get">
