	...
	<body>
		<div class="yhzx_rightside">
			...
			<div class="sale_list_lead mt10" style=" background:#E1F0FF; padding-bottom:5px">
				<form name="particulars_search" action="${ctx}/user/account/particulars.shtml">
					<div>
						...
						类型：<s:select name="type" list="#{'':'所有类型','1':'交易付款','2':'交易收款','3':' 充　值 ','4':' 退　款 ','5':' 提　现 ','6':'差额入账'}" listKey="key" listValue="value" multiple="simple"></s:select>
					</div>
		...
		<s:iterator value="particularsList">
			...
			<div class="sale_list">
				...
				<div class="wb8 tc">
					<s:if test="expense!=null">${expense }元</s:if>
				</div>
				<div class="wb8 tc">
					${money}元
				</div>
			...
			<div class="manu">
				...
				<form name="pageForm" action="${ctx}/user/account/particulars.shtml" method="get">
