...
<%--   <div class="clear pd10"><a href="#" target="_blank" class="blue_u f12">◆信用等级如何划分？</a><a href="#" target="_blank"  class="blue_u ml10 f12">◆为什么评价没有计分？</a><a href="#" target="_blank"  class="blue_u ml10 f12">◆什么是信用炒作？</a><a href="#" target="_blank"  class="blue_u ml10 f12">◆如何进行修改评价？</a><a href="#" target="_blank"  class="blue_u ml10 f12">◆有中差评怎么办？</a></div>--%>
  <div id="rightnav">
    <ul>
      <li class="action_nav" onclick="javascript:window.location='${ctx}/user/trade/credit/userCredit1.shtml?userID=${user.id}&type=1'"><span>来自买家的评价</span></li>
	...
	<s:iterator value="sellerAssess">
		<s:if test="grade==1">
			...
			<div class="sale_u3 ml10">
				<ul>
					<li>卖家：${passive.username}　信用：${passive.userInfo.buyerCredit}<span class="srank-buy-3">&nbsp;</span> </li>
...
function ping(grade)
{
	window.location.href="${ctx}/user/trade/credit/userCredit1.shtml?&type=1&userID=${user.id}&grade="+grade;
}
</script>
