...
<html>
	<head>
		...
		<script type="text/javascript">
			function checkForm(){
				...
				var actionURL = $("actionURL").value.Trim();
	...
	<body>
		...
		<form name="form1" action="${ctx}/admin/menu/menuAdmin!saveThird.shtml" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtable1">
			...
			<tr>
				...
				<td width="81%">
					<INPUT class="upfile" id="actionURL" name="menu.actionURL" size=80 value="${menu.actionURL}" />
					<span class="red"></span>
				</td>
			</tr>
			<tr>
				...
				<td width="81%">
					<INPUT class="upfile" id="target" name="menu.target" size=80 value="${menu.target}" />
					<span class="red"></span>
				</td>
			</tr>
			<tr>
